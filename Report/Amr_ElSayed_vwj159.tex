...
\subsection{Fixed Bit String}%Different Mathematical Notation}%precision}% to represent a number
...
%====================================================================================================%
%Different mathematical notation for floating point precision is one of the obvious shortcomings for designing CPBA application, if we could not %represent those different precision with their actual mathematical notation.\\%length.\\
%====================================================================================================%
%Different mathematical notation for floating point precision is one of the obvious shortcomings for designing CPBA application, if we could not represent those mathematical notation with their actual digit.\\%length.\\
%====================================================================================================%
...
%\begin{itemize}\item[]{The positive mathematical notation for this precision is:\\65535.}\end{itemize}%range between\\0 to 65535.}\end{itemize}
%\item{Single-precision is $2^{32}$}
%\begin{itemize}\item[]{The positive mathematical notation for this precision is:\\4294967295.}\end{itemize}%range between\\0 to 4294967295.}\end{itemize}
%\item{Double-precision is $2^{64}$}
%\begin{itemize}\item[]{The positive mathematical notation for this precision is:\\18446744073709551615.}\end{itemize}%range between\\0 to 18446744073709551615.}\end{itemize}
%\item{Quadruple-precision is $2^{128}$}
%\begin{itemize}\item[]{The positive mathematical notation for this precision is:\\340282366920938463374607431768211455.}\end{itemize}%range between\\0 to 340282366920938463374607431768211455.}\end{itemize}
%\end{itemize}
...
\subsection{Rectangle Size vs Bit Pixel}% to represent a number
...
%hello \cite{Goldberg:1991:CSK:103162.103163}
%c .\citep{Guo:2013:OPT:2445196.2445368}
\newpage
\section*{References}
